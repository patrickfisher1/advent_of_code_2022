                ...
                if ip.starts_with("move") {
                    ...
                    for i in 0..NUM_STACKS {
                        ...
                        if crate_chars.starts_with('[') {
                            stacks[i].push_back(crate_chars.chars().nth(1).unwrap())
                        }
                    }
                }
            }
